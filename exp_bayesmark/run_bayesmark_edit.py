...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_unk_mode', action='store_true')
    ...
    benchmark = BayesmarkExpRunner(task_context, data, seed, args.use_unk_mode)

    prompt_setting = 'full_context'
    if args.use_unk_mode:
        tmp = {}
    ...
    elif 'LLAMBO' in args.out_name:
        llambo = LLAMBO(task_context, sm_mode, n_candidates=10, n_templates=2, n_gens=10, prompt_setting=prompt_setting,
    ...
    elif 'GLAMBO' in args.out_name:
        llambo = GLLAMBO(task_context, sm_mode, n_candidates=10, n_templates=2, n_gens=10, prompt_setting=prompt_setting,
                        alpha=0.1, n_initial_samples=5, n_trials=25, init_f=benchmark.generate_initialization,
                        bbox_eval_f=benchmark.evaluate_point, chat_engine=chat_engine, top_pct=top_pct)
    ...
    search_history.to_csv(f'{save_res_dir}/{args.out_name}.csv', index=False)
